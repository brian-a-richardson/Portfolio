/*
File Name: LightScene.java
Author:  Brian Richardson
Date: 7/18/2021
Description: This a lighting demo using jogl
Code Source:
Eck, D. J. (2018, January). Introduction to Computer Graphics. Introduction to Computer Graphics. http://math.hws.edu/graphicsbook/.
...
/**
 *  Shows a number of textured objects that are illuminated
 ...
 */
public class Scene extends JPanel implements GLEventListener {

    public static void main(String[] args) {
        JFrame window = new JFrame("A Shape Scene");
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        Texture[] textures = createTextureArray();

        // create a sphere on the base
        textures[3].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
        textures[3].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
        ...
        gl.glPushMatrix();
        TexturedShapes.uvSphere(gl, 5, 40, 40, true);
        gl.glPopMatrix();

        // create a cube on the base
        textures[2].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
        textures[2].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
        textures[2].enable(gl);

        gl.glTranslated(10, 10, 1);
        gl.glScaled(1.5, 1.5,1.5);

        gl.glPushMatrix();
        TexturedShapes.cube(gl, 5,true);
        gl.glPopMatrix();

        // create a cone on the base
        textures[5].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
        textures[5].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
        textures[5].enable(gl);

        gl.glTranslated(-15, 0, 2);
        gl.glRotated(180, 1, 0, 0);
        gl.glScaled(1.5, 1.5,1.5);

        gl.glPushMatrix();
        TexturedShapes.uvCone(gl, 2, 5,5,5,5, true);
        gl.glPopMatrix();

        // create a torus on the base
        textures[4].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
        textures[4].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
        ...
        gl.glPushMatrix();
        TexturedShapes.uvTorus(gl, 4, 2,40,40,true);
        gl.glPopMatrix();

        // create a a more complex shape using several shapes
        textures[3].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
        textures[3].setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
        textures[3].enable(gl);

        gl.glTranslated(5, -7, 2);
        gl.glScaled(1, 1,1);

        gl.glPushMatrix();
        TexturedShapes.uvSphere(gl, 1, 40, 40, true);
        gl.glTranslated(0, 0, -0.5);
        TexturedShapes.uvSphere(gl, 1, 40, 40, true);
        gl.glTranslated(0, 0, -0.5);
        TexturedShapes.uvSphere(gl, 1, 40, 40, true);
     ...
     * Support functions
     */
    public Texture[] createTextureArray(){
